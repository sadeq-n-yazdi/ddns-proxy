...
# DEFAULT SETTINGS
SERVER="user@service.example.com"
SERVER_SSH_PARAM=""
SERVER_SCP_PARAM=""
APP_DEPLOY_NAME="service.example.com"
...
ssh $SERVER_SSH_PARAM "$SERVER" "systemctl stop '$SERVICE_NAME'; mkdir -p '/opt/websites/${APP_DEPLOY_NAME}'; [ -f '/opt/websites/${APP_DEPLOY_NAME}/${APP_DEPLOY_NAME}.app' ] && mv '/opt/websites/${APP_DEPLOY_NAME}/${APP_DEPLOY_NAME}.app' '/opt/websites/${APP_DEPLOY_NAME}/${APP_DEPLOY_NAME}.app.old' && echo 'Backup old app completed'; exit 0"
